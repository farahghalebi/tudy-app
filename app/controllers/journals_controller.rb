...
Instructions:
Ignore emotions, extract only actionable tasks.
Each task must include:
title: 1-3 words, concise, with an emoji if possible
description: short, actionable explanation
Output only valid JSON (no extra text).
following this pattern: [{title: 'groceries', description: 'cooking dinner for friends'},{title: 'meditate', description: 'recover from hard work day and finally give them back in order'"
